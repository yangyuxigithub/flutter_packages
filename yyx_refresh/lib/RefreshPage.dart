      ...
      body: Container(
        child: NotificationListener<ScrollNotification>(
          ...
          onNotification: (ScrollNotification notification) {
            ...
            setState(() {
              if (notification.metrics.outOfRange && pix <= 0) {
                //下拉
                height = -pix;
              }
...
const double _kMinFlingVelocity = 50.0;
...
class RefreshPhysics extends ScrollPhysics {
  ...
  Simulation createBallisticSimulation(ScrollMetrics position, double velocity) {
    ...
    //下拉触发
    if (_timer == null && position.outOfRange && position.pixels <= pauseX) {
      refresh = true;
  ...
  // to trigger a fling.
  @override
  double get minFlingVelocity => _kMinFlingVelocity * 2.0;
